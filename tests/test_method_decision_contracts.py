...
def test_v21_l4_method_extension_is_atomic():
    delta = {
        ...
        "strategies": [{
            "strategy_id": "S1",
            "hypothesis_ids": ["H1"],
            "name": "Cross-species expression analysis",
            "steps": ["map orthologs"],
        }],
        "method_components": [{
            "component_id": "orthology",
            "name": "Orthology mapping",
            "required": True,
            "rationale": "Build a comparable gene space.",
        }],
        "method_candidates": [{
            "method_id": "ensembl_1to1",
            "component_id": "orthology",
            "hypothesis_ids": ["H1"],
            "name": "Ensembl one-to-one orthologs",
            "status": "eligible",
            "purpose": "Restrict analysis to comparable genes.",
            "applicable_to": ["multi-species expression"],
            "implementation_steps": [
                "retrieve ortholog table",
                "filter one-to-one genes",
            ],
...
def test_v21_l5_validates_candidate_level_critiques_when_present():
    delta = {
        ...
        "attacks": [{
            ...
            "strategy_id": "S1",
            "severity": "major",
            "text": "Ortholog filtering may bias conserved pathways.",
            "resolution": "Report retained-gene coverage.",
        }],
        "qc_checkpoints": [{
            "hypothesis_ids": ["H1"],
            "strategy_id": "S1",
            "name": "ortholog coverage",
            "criterion": ">=70% expressed genes retained",
        }],
        "failure_stop_rules": [{
            "hypothesis_ids": ["H1"],
            "strategy_id": "S1",
        ...
        "method_critiques": [{
            ...
            "component_id": "orthology",
            "verdict": "MODIFY",
            "assumption_risks": ["annotation completeness differs"],
            "required_diagnostics": ["coverage by species"],
            "failure_modes": ["systematic gene loss"],
            "recommended_modifications": [
                "sensitivity analysis with gene families"
            ],
        }],
    }
...
def test_v21_l6_validates_selected_methods_when_present():
    delta = {
        ...
        "analysis_plan": [{
            ...
            "parameters": {"orthology": "one_to_one"},
            "outputs": ["ortholog_matrix.tsv"],
            "feasibility_assessment": {
                "verdict": "PASS",
                "evidence": "The input and required software are available.",
            },
        }],
        ...
        "selected_methods": [{
            "component_id": "orthology",
            "selected_method_ids": ["ensembl_1to1"],
            "decision_rationale": (
                "Auditable one-to-one mapping for the primary analysis."
            ),
            "rejected_alternatives": [{
                "method_id": "gene_family",
                "reason": "Reserved for sensitivity analysis.",
            }],
            ...
            "method_anchor_ids": ["A1"],
            "l5_qc_requirements": [
                "report retained-gene coverage by species"
            ],
        }],
    }
