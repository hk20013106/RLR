    ...
    "provider_runtime_integrity": VerificationProfile(
        ...
        required_validation=(
            _pytest_step(
                ...
                "tests/test_meta_rlr_codex_cli.py",
                "tests/test_provider_runtime_observability.py",
                "-q",
            ),
            _pytest_step(
                "bounded_maintenance_external_execution",
                "tests/test_rlr_maintenance_bounded_process.py",
                "tests/test_meta_rlr_loopx_cli.py",
                "tests/test_meta_rlr_workspace.py",
                "tests/test_meta_rlr_verification.py",
                "-q",
            ),
            _pytest_step(
                "host_settlement_recovery",
                "tests/test_meta_rlr_host.py",
                "tests/test_meta_rlr_phase2_recovery_commit.py",
                "tests/test_meta_rlr_phase2_loopx_settlement.py",
                "tests/test_meta_rlr_phase2_frontier_guard.py",
                "-q",
            ),
            _pytest_step(
                "autowake_bridge",
