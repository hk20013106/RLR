...
DAG_NODES = [
    ...
    },
    {
        ...
        "acquisition_owner": "research_loop.l05_curie",
    ...
    },
    {
        ...
        "research_owner": "research_loop.l05_curie.multisource",
        "structured_execution": "generic_model",
    ...
    },
    {
        ...
        "research_persona": "Curie", "research_required": True,
        "research_owner": "research_loop.l05_curie.multisource",
        "evidence_owner": "research_loop.l05_curie.source_verifier",
        "semantic_owner": "research_loop.l05_curie.semantic_verifier",
        "structured_execution": "generic_model",
        "action_hint": "Verify L7/L8 findings through canonical multisource discovery and source-located semantic adjudication",
        "must": ["Derive searches from the actual L7/L8 findings", "Resolve provider records through canonical paper identity before retrieval", "Produce exactly one supports, contradicts, or unresolved verdict for every active finding", "Use source-located evidence; a DOI or PMID alone is not verified"],
