...
from research_loop.internal_english_context import (
    install as _install_internal_english_context,
)
...
# Once the canonical contract is frozen, every cognitive context uses English
# scientific semantics; legacy display text is excluded for normalized candidates.
_install_internal_english_context(_context)
...
del _install_l0_language_boundary, _install_internal_english_context
