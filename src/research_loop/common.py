...
def _check_dependencies(project_dir=None, *, backend=None,
                        persist_receipt=False, return_results=False):
    ...
    if project_dir:
        ...
        result = (ok, missing, advisory)
        return (*result, results) if return_results else result
