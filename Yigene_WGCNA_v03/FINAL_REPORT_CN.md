...
**环境：** python=3.13; r_version=4.6.0 (D:/Programs/R/R-4.6.0/bin/Rscript.exe); r_library=D:/R-HK/Seurat5_lib (798 包); everos=在线 (http://localhost:9000 (configurable)); obsidian_vault=OBSIDIAN_VAULT env var
